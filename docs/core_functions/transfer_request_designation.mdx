...
stateDiagram-v2
    ...
    state "Transfer" as transfer_procedure
    state "Transport" as transport_procedure
    ...
    select_designation_type --> transfer_procedure
    select_designation_type --> transport_procedure
    transfer_procedure --> transfer_request_assigned
    transport_procedure --> activity_created
