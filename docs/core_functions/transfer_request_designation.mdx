...
stateDiagram-v2
    ...
    designation_type --> transfer_procedure
    designation_type --> transport_procedure
    transfer_procedure --> [*]: Transfer Request Assigned
    transport_procedure --> [*]: Activity Created 
```
